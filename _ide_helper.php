...
namespace Bga\GameFramework {
    ...
    abstract class UserPreferences
    {
         ...
         */
        public function get(int $playerId, int $prefId): ?int
        {
            return null;
        }
    }
    ...
    abstract class Table extends \APP_Object
    {
         ...
         */
        public readonly \Bga\GameFramework\GamestateMachine $gamestate;

        /**
         * Access the underlying global values.
         */
        public readonly \Bga\GameFramework\Db\Globals $globals;

        /**
         * Access the underlying Notify object.
         */
        public readonly \Bga\GameFramework\Notify $notify;

        /**
         * Access the underlying Legacy object.
         */
        public readonly \Bga\GameFramework\Legacy $legacy;

        /**
         * Access the underlying TableOptions object.
         */
        public readonly \Bga\GameFramework\TableOptions $tableOptions;

        /**
         * Access the underlying UserPreferences object.
         */
        public readonly \Bga\GameFramework\UserPreferences $userPreferences;

        /**
         * Access the underlying DeckFactory object.
         */
        public readonly \Bga\GameFramework\Components\DeckFactory $deckFactory;

        /**
         * Access the underlying CounterFactory object.
         */
        public readonly \Bga\GameFramework\Components\Counters\CounterFactory $counterFactory;

        /**
         * Access the underlying PlayerCounter object for player_score.
         */
        public readonly \Bga\GameFramework\Components\Counters\PlayerCounter $playerScore;

        /**
         * Access the underlying PlayerCounter object for player_score_aux.
         */
        public readonly \Bga\GameFramework\Components\Counters\PlayerCounter $playerScoreAux;
         ...
         */
        public function applyDbUpgradeToAllDB(string $sql): void
        {
        }
         ...
         */
        public function getGenericGameInfos(string $api, array $args = []): array
        {
            return [];
        }
         ...
         */
        public static function getBgaEnvironment(): string
        {
            return '';
        }
    }
...
namespace Bga\GameFramework\Components {
    ...
    class Deck extends \Deck
    {
         ...
         */
        public function getExtremePosition(bool $getMax, string $location): int
        {
            return false;
        }
         ...
         * Return card infos or null if no card in the specified location.
         */
        public function pickCardForLocation(string $from_location, string $to_location, int $location_arg = 0): ?array
        {
            return [];
        }
         ...
         */
        public function pickCardsForLocation(int $nbr, string $from_location, string $to_location, int $location_arg = 0, bool $no_deck_reform = false): ?array
        {
            return [];
        }
         ...
         */
        public function moveCards(array $cards, string $location, int $location_arg = 0): void
        {
        }
         ...
         */
        public function insertCard(int $card_id, string $location, int $location_arg): void
        {
        }
         ...
         */
        public function moveAllCardsInLocationKeepOrder(string $from_location, string $to_location): void
        {
        }
         ...
         */
        public function getCardsInLocation(string|array $location, ?int $location_arg = null, ?string $order_by = null): array
        {
            return [];
        }
         ...
         */
        public function getCardsFromLocation(array $cards_array, string $location, ?int $location_arg = null): array
        {
            return [];
        }
         ...
         */
        public function getCardsOfType(mixed $type, ?int $type_arg = null): array
        {
            return [];
        }
         ...
         */
        public function getCardsOfTypeInLocation(mixed $type, ?int $type_arg = null, string $location, ?int $location_arg = null): array
        {
            return [];
        }
         ...
         */
        public function playCard(int $card_id): void
        {
        }
         ...
         */
        public function countCardInLocation(string $location, ?int $location_arg = null): int|string
        {
            return '0';
        }
         ...
         * Return the number of cards in specified location.
         */
        public function countCardsInLocation(string $location, ?int $location_arg = null): int|string
        {
            return '0';
        }
...
namespace {
    ...
    abstract class game_view
    {
         ...
         */
        protected readonly \Bga\GameFramework\Table $game;

        /**
         * Underlying access to the template.
         */
        protected readonly APP_Template $page;
